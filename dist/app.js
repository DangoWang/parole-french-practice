...
function renderAI(){
 const box=$('ai-feedback');if(!box)return;if(inputWasVoice){box.innerHTML='<p>本次使用口语评分 · GPT-Audio-1.5。'+(speaking?.hasRecording()?'请查看下方口语反馈。':'录音已释放，请自行评分，或重新录音。')+'</p>';return;}
